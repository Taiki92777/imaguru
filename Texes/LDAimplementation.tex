...
\makeatother
    ...
    \section{LDA実装}\label{ldaux5b9fux88c5}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}20}]:} \PY{c+c1}{\PYZsh{} data loading}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}21}]:} \PY{c+c1}{\PYZsh{} standard scaling}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}22}]:} \PY{c+c1}{\PYZsh{}mean vecs}
...
MV 3: [ 0.1992  0.866   0.1682  0.4148 -0.0451 -1.0286 -1.2876  0.8287 -0.7795
  0.9649 -1.209  -1.3622 -0.4013]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}23}]:} \PY{c+c1}{\PYZsh{} within\PYZhy{}class scatter matrix}
         \PY{n}{d}\PY{o}{=}\PY{l+m+mi}{13}
...
Within-class scatter matrix: 13X13
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}24}]:} \PY{c+c1}{\PYZsh{} check class label distribution}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Class label distribution: }\PY{l+s+si}{\PYZpc{}s}\PY{l+s+s1}{\PYZsq{}} \PY{o}{\PYZpc{}} \PY{n}{np}\PY{o}{.}\PY{n}{bincount}\PY{p}{(}\PY{n}{y\PYZus{}train}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{:}\PY{p}{]}\PY{p}{)}
\end{Verbatim}
...
Class label distribution: [41 50 33]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}25}]:} \PY{c+c1}{\PYZsh{} scaled Sw(scaling===\PYZgt{}\PYZgt{}\PYZgt{}covariance)}
         \PY{n}{d}\PY{o}{=}\PY{l+m+mi}{13}
         \PY{n}{S\PYZus{}W}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{(}\PY{n}{d}\PY{p}{,}\PY{n}{d}\PY{p}{)}\PY{p}{)}
         \PY{k}{for} \PY{n}{label}\PY{p}{,} \PY{n}{mv} \PY{o+ow}{in} \PY{n+nb}{zip}\PY{p}{(}\PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{)}\PY{p}{,} \PY{n}{mean\PYZus{}vecs}\PY{p}{)}\PY{p}{:}
         ...
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Scaled\PYZhy{}Within\PYZhy{}class scatter matrix: }\PY{l+s+si}{\PYZpc{}s}\PY{l+s+s1}{X}\PY{l+s+si}{\PYZpc{}s}\PY{l+s+s1}{\PYZsq{}} \PY{o}{\PYZpc{}} \PY{p}{(}\PY{n}{S\PYZus{}W}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,}\PY{n}{S\PYZus{}W}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
Scaled-Within-class scatter matrix: 13X13
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}26}]:} \PY{c+c1}{\PYZsh{} Between\PYZhy{}Class scatter matrix}
         \PY{n}{mean\PYZus{}overall}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{x\PYZus{}train\PYZus{}std}\PY{p}{,}\PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{)}
         \PY{n}{d}\PY{o}{=}\PY{l+m+mi}{13}
         ...
         \PY{k}{for} \PY{n}{i}\PY{p}{,}\PY{n}{mean\PYZus{}vec} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{mean\PYZus{}vecs}\PY{p}{)}\PY{p}{:}
             \PY{n}{n}\PY{o}{=}\PY{n}{x\PYZus{}train}\PY{p}{[}\PY{n}{y\PYZus{}train}\PY{o}{==}\PY{n}{i}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{,}\PY{p}{:}\PY{p}{]}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]} \PY{c+c1}{\PYZsh{}class=i+1のサンプル数}
             \PY{n}{mean\PYZus{}vec}\PY{o}{=}\PY{n}{mean\PYZus{}vec}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{n}{d}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}
...
Between-class scatter matrix: 13X13
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}27}]:} \PY{c+c1}{\PYZsh{} calculate eigen factors and sort eigen values}
         \PY{n}{eigen\PYZus{}vals}\PY{p}{,}\PY{n}{eigen\PYZus{}vecs}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{linalg}\PY{o}{.}\PY{n}{eig}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{linalg}\PY{o}{.}\PY{n}{inv}\PY{p}{(}\PY{n}{S\PYZus{}W}\PY{p}{)}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{S\PYZus{}B}\PY{p}{)}\PY{p}{)}
         ...
         \PY{c+c1}{\PYZsh{} Sbはランクが1以下の行列をクラス数cだけ足したものなので、最大c\PYZhy{}1しか固有値は存在しない}
\end{Verbatim}
...
1.2123024580195727e-15
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}28}]:} \PY{c+c1}{\PYZsh{} dsicriminability}
         \PY{n}{tot}\PY{o}{=}\PY{n+nb}{sum}\PY{p}{(}\PY{n}{eigen\PYZus{}vals}\PY{o}{.}\PY{n}{real}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}29}]:} \PY{c+c1}{\PYZsh{} show figure(discriminability \PYZam{} cumlative dicriminability)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{bar}\PY{p}{(}\PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{14}\PY{p}{)}\PY{p}{,}\PY{n}{discr}\PY{p}{,}\PY{n}{alpha}\PY{o}{=}\PY{l+m+mf}{0.5}\PY{p}{,}\PY{n}{align}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{center}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{label}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{discriminability}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{step}\PY{p}{(}\PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{14}\PY{p}{)}\PY{p}{,}\PY{n}{cum\PYZus{}discr}\PY{p}{,}\PY{n}{where}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{mid}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{label}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{cumulative discriminability}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} 
         \PY{n}{plt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{discriminability ratio}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} 
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}30}]:} \PY{c+c1}{\PYZsh{} select most important eigen factors}
         \PY{n}{w}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{hstack}\PY{p}{(}\PY{p}{(}\PY{n}{eigen\PYZus{}pairs}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{n}{np}\PY{o}{.}\PY{n}{newaxis}\PY{p}{]}\PY{o}{.}\PY{n}{real}\PY{p}{,}\PY{n}{eigen\PYZus{}pairs}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{n}{np}\PY{o}{.}\PY{n}{newaxis}\PY{p}{]}\PY{o}{.}\PY{n}{real}\PY{p}{)}\PY{p}{)}
...
Matrix W:
 ...
 [ 0.3915 -0.5958]]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}31}]:} \PY{c+c1}{\PYZsh{} X\PYZsq{}=XW}
         \PY{n}{x\PYZus{}train\PYZus{}lda}\PY{o}{=}\PY{n}{x\PYZus{}train\PYZus{}std}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{w}\PY{p}{)}
         ...
         \PY{k}{for} \PY{n}{l}\PY{p}{,}\PY{n}{c}\PY{p}{,}\PY{n}{m} \PY{o+ow}{in} \PY{n+nb}{zip}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{unique}\PY{p}{(}\PY{n}{y\PYZus{}train}\PY{p}{)}\PY{p}{,}\PY{n}{colors}\PY{p}{,}\PY{n}{markers}\PY{p}{)}\PY{p}{:}
             \PY{n}{plt}\PY{o}{.}\PY{n}{scatter}\PY{p}{(}\PY{n}{x\PYZus{}train\PYZus{}lda}\PY{p}{[}\PY{n}{y\PYZus{}train}\PY{o}{==}\PY{n}{l}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,}\PY{n}{x\PYZus{}train\PYZus{}lda}\PY{p}{[}\PY{n}{y\PYZus{}train}\PY{o}{==}\PY{n}{l}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,}\PY{n}{c}\PY{o}{=}\PY{n}{c}\PY{p}{,}\PY{n}{label}\PY{o}{=}\PY{n}{l}\PY{p}{,}\PY{n}{marker}\PY{o}{=}\PY{n}{m}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}32}]:} \PY{c+c1}{\PYZsh{} Sklearn implementation}
         \PY{n}{lda}\PY{o}{=}\PY{n}{LDA}\PY{p}{(}\PY{n}{n\PYZus{}components}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{)}
         \PY{n}{x\PYZus{}train\PYZus{}lda\PYZus{}sk}\PY{o}{=}\PY{n}{lda}\PY{o}{.}\PY{n}{fit\PYZus{}transform}\PY{p}{(}\PY{n}{x\PYZus{}train\PYZus{}std}\PY{p}{,}\PY{n}{y\PYZus{}train}\PY{p}{)}
         \PY{n}{lr}\PY{o}{=}\PY{n}{LogisticRegression}\PY{p}{(}\PY{p}{)}
         \PY{n}{lr}\PY{o}{=}\PY{n}{lr}\PY{o}{.}\PY{n}{fit}\PY{p}{(}\PY{n}{x\PYZus{}train\PYZus{}lda\PYZus{}sk}\PY{p}{,}\PY{n}{y\PYZus{}train}\PY{p}{)}
\end{Verbatim}
...
C:\textbackslash{}Users\textbackslash{}taiki\textbackslash{}AppData\textbackslash{}Local\textbackslash{}Programs\textbackslash{}Python\textbackslash{}Python37\textbackslash{}lib\textbackslash{}site-packages\textbackslash{}sklearn\textbackslash{}linear\_model\textbackslash{}logistic.py:460: FutureWarning: Default multi\_class will be changed to 'auto' in 0.22. Specify the multi\_class option to silence this warning.
  "this warning.", FutureWarning)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}33}]:} \PY{c+c1}{\PYZsh{} show figure}
         \PY{n}{pdr}\PY{p}{(}\PY{n}{x\PYZus{}train\PYZus{}lda\PYZus{}sk}\PY{p}{,}\PY{n}{y\PYZus{}train}\PY{p}{,}\PY{n}{classifier}\PY{o}{=}\PY{n}{lr}\PY{p}{)}
...
'c' argument looks like a single numeric RGB or RGBA sequence, which should be avoided as value-mapping will have precedence in case its length matches with 'x' \& 'y'.  Please use a 2-D array with a single row if you really want to specify the same RGB or RGBA value for all points.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}34}]:} \PY{c+c1}{\PYZsh{} test check}
         \PY{n}{x\PYZus{}test\PYZus{}lda\PYZus{}sk}\PY{o}{=}\PY{n}{lda}\PY{o}{.}\PY{n}{transform}\PY{p}{(}\PY{n}{x\PYZus{}test\PYZus{}std}\PY{p}{)}
         \PY{n}{pdr}\PY{p}{(}\PY{n}{x\PYZus{}test\PYZus{}lda\PYZus{}sk}\PY{p}{,}\PY{n}{y\PYZus{}test}\PY{p}{,}\PY{n}{classifier}\PY{o}{=}\PY{n}{lr}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{LD1}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{LD2}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
'c' argument looks like a single numeric RGB or RGBA sequence, which should be avoided as value-mapping will have precedence in case its length matches with 'x' \& 'y'.  Please use a 2-D array with a single row if you really want to specify the same RGB or RGBA value for all points.
    ...
    2次元の特徴部分空間でもテストで100％線形分類できていることがわかる
